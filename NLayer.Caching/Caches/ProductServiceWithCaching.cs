...
namespace NLayer.Caching.Caches
{
    public class ProductServiceWithCaching : IProductService
    {
        ...
        public Task<Product> GetByIdAsync(int id)
        {
            ...
            /*
             * If you want to write in a single line, you can use this format
             * return product is null ? throw new NotFoundException($"{typeof(Product).Name} not found. id = ({id})") : Task.FromResult(product);
             */
        }
        ...
        public Task<CustomResponseDto<List<ProductWithCategoryDto>>> GetProductWithCategory()
        {
            ...
            /*
             * If you don't want to use it from the cache, you can call it directly from the database in cases where you think it is rarely called.
